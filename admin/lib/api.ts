...
export const educationApi = {
  ...
  createClass: (data: { name: string; description?: string; thumbnailKey?: string }) =>
  ...
  // Subjects
  getSubjects: (params?: { classId?: string; page?: number; limit?: number; search?: string }) =>
    api.get('/subjects', { params }),
  
  createSubject: (data: { name: string; description?: string; classId: string }) =>
    api.post('/subjects', data),
  
  updateSubject: (id: string, data: { name: string; description?: string; classId: string, thumbnailKey?: string }) =>
  ...
  // Chapters
  getChapters: (params?: { subjectId?: string; page?: number; limit?: number; search?: string }) =>
    api.get('/chapters', { params }),
  
  createChapter: (data: { name: string; description?: string; subjectId: string; order?: number }) =>
    api.post('/chapters', data),
  
  updateChapter: (id: string, data: { name: string; description?: string; subjectId: string; order?: number }) =>
  ...
  approveContent: (id: string) =>
    api.patch(`/admin/content/${id}/approve`),
...
export const usersApi = {
  ...
  approveTeacher: (id: string) =>
    api.patch(`/admin/teachers/${id}/approve`),
...
export const uploadApi = {
  getPresignedUrl: (data: { fileName: string; contentType: string; fileSize?: number }) =>
...
export const analyticsApi = {
  ...
  getContentStats: () =>
    api.get('/analytics/admin/content'),
  
  getEngagementStats: () =>
    api.get('/analytics/admin/engagement'),
  
  getSalesStats: () =>
    api.get('/analytics/admin/sales'),
};