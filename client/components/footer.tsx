...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t bg-gray-700 text-white overflow-hidden">
      {/* Background Glow */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-base text-white/80 max-w-xl">
                    Join thousands of students and parents using CampusLane to
                    stay ahead. One subscription gives you unlimited access to
                    interactive lessons, real-time progress tracking, and
                    expert-designed worksheets.
                  </p>
                </div>
              </div>
