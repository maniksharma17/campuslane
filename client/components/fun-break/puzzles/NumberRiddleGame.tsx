...
const QUESTION = {
  riddle: "I am thinking of a number. If you double me and add 6, you get 20. What is my number?",
  options: ["7", "8", "9", "10"],
  answer: "7",
  funFact: "Double 7 = 14, and 14 + 6 = 20. That’s why 7 is the right answer!",
};
...
export default function NumberRiddleGame({
  ...
  const handleSelect = (opt: string) => {
    ...
    // feedback cartoon index
    const idxPick = correct ? Math.floor(Math.random() * 8) + 1 : Math.floor(Math.random() * 4) + 1;
  ...
  return (
    <div className="w-full mx-auto bg-white rounded-2xl shadow-md p-6 border border-gray-200">
      <div className="flex flex-col md:flex-row gap-6">
        {/* LEFT column: riddle + options + fun fact */}
          ...
          <AnimatePresence>
            {attempted && (
              ...
              >
                ...
                <div className="text-sm text-gray-800">{QUESTION.funFact}</div>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
