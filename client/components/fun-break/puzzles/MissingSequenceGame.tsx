...
export default function MissingSequenceGame({
  onScore,
  onNext,
  nextLabel = "Next",
  retryLabel = "Retry",
    ...
    <div className="w-full mx-auto bg-white rounded-2xl shadow-md p-6 border border-gray-200">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          >
            Complete the number sequence: <br />
            <span className="font-mono text-2xl">2, 4, 6, __, 10</span>
          </motion.h3>
            ...
            {OPTIONS.map((opt) => {
              ...
              return (
                <motion.button
                  ...
                  disabled={attempted}
                  className={`rounded-full p-4 text-lg font-semibold transition-all duration-200 w-full text-center ${styleClass}`}
                >
                  {opt}
                </motion.button>
              );
            ...
            {attempted && (
              ...
              >
                ...
                <div className="text-sm text-gray-800">
                  {isCorrect
                    ? "The sequence increases by 2 each time. After 6 comes 8."
                    : "Look closely — each step adds 2."}
                </div>
              </motion.div>
            )}
          </AnimatePresence>
