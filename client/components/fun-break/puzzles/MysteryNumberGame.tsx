...
export default function MysteryNumberGame({
  onScore,
  onNext,
  nextLabel = "Next",
  retryLabel = "Retry",
    ...
    <div className="w-full mx-auto bg-white rounded-2xl shadow-md p-6 border border-gray-200">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          >
            I am a 3-digit number. All my digits are the same. I am between 300
            and 400. Who am I?
          </motion.h3>
            ...
            {attempted && (
              ...
              >
                ...
                <div className="text-sm text-gray-800">
                  The only 3-digit number between 300–400 with all digits the
                  same is <b>333</b>.
                </div>
              </motion.div>
            )}
