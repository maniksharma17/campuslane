...
// Student routes
router.get('/links/pending', requireAuth, ParentChildController.getPendingLinks);
...
router.delete('/links/:id', requireAnyAuth, validateParams(z.object({ id: mongoIdSchema })), ParentChildController.deleteLink);
